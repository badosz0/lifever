...
export function SettingsDialog({ open, onOpenChange }: SettingsDialogProps) {
  ...
  const { dateFormat, setDateFormat, setTimeFormat, timeFormat } =
    useUserPreferences();
  const accountName = session?.user.name ?? "Showcase";
  const accountDetail =
    session?.user.email ?? "Temporary screenshot fixture";
