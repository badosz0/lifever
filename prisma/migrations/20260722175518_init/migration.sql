-- CreateEnum
CREATE TYPE "ReminderPriority" AS ENUM ('NONE', 'LOW', 'MEDIUM', 'HIGH');
...
CREATE TABLE "reminder" (
    ...
    "priority" "ReminderPriority" NOT NULL DEFAULT 'NONE',
    "repeatRule" TEXT,
...
-- AddForeignKey
ALTER TABLE "reminder" ADD CONSTRAINT "reminder_listId_fkey" FOREIGN KEY ("listId") REFERENCES "reminder_list"("id") ON DELETE SET NULL ON UPDATE CASCADE;
